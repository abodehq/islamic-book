...
public class PublishersBooksActivity extends Activity {

	private PublishersBooksActivity _scope;
	...
	public static String publisherId = "1";
	...
	private ReturnModel GetData() {
		...
		try {
			...
			Object result = amfConnection.call("BooksServices.getPublisherBooks",
					new Object[] {publisherId,  lastselectedImagePosition, 10 });
			...
			try {
				...
				for (int i = 0; i < jsonArray.length(); i++) {
					...
					book.put("publisherId", authorObj.getString("publisherId"));
					book.put("publishersName",
							authorObj.getString("publisherName"));
